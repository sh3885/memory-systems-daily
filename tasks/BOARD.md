...
Only one owner may hold a task. Parallel write tasks must have disjoint `Owned paths`.
...
- T-063 Make the web admin password authorize post listing and editing, completed 2026-07-27. See `tasks/handoffs/T-063.md`.
...
- T-018 AI provider fallback router, completed 2026-07-22. See `tasks/handoffs/T-018.md`.
