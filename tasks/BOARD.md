...
- Owner: unassigned
- Role: Researcher + Automation Engineer
- Owned paths: to be assigned before work
- Done when: a curriculum topic produces a draft and claim ledger from primary sources
- Status: ready

### T-013 Approval and GitHub publishing

- Owner: unassigned
- Role: Automation Engineer + QA Reviewer
- Owned paths: to be assigned before work
